...
public class SplitterTest {
    private Disposable myAppDisposable;

//    @BeforeEach
//    public void before() {
//        LightApplicationBuilder.create(myAppDisposable = Disposable.newDisposable()).build();
//    }

//    @AfterEach
//    public void after() {
//        Disposer.dispose(myAppDisposable);
//        myAppDisposable = null;
//    }
    ...
    private static List<String> wordsToCheck(TokenSplitter splitter, String text) {
        ...
        splitter.split(text, TextRange.allOf(text), (Consumer<TextRange>) textRange -> words.add(textRange.substring(text)));
        return words;
    }
